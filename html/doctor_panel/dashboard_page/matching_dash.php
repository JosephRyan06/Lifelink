...
function displayPatientNeeds($conn) {
    ...
    $maxPatientRows = max($organ_typeResult->num_rows, $blood_cellResult->num_rows, $blood_typeResult->num_rows);
...
function displayNewMatches($conn) {
    ...
    SELECT 
        ...
        CASE
            ...
            WHEN d.blood_cell = p.blood_cell AND d.blood_cell IS NOT NULL THEN d.blood_cell
        END AS match_type,
    ...
    INNER JOIN patients p
        ON (
            ...
            OR
            (d.blood_type = p.blood_type AND d.blood_type IS NOT NULL AND d.blood_cell = p.blood_cell AND d.blood_cell IS NOT NULL)
        )
